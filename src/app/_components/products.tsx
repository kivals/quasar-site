...
function ProductItem({
  ...
  return (
    <article
      className="flex h-[190px] items-center justify-center rounded-[30px] bg-white bg-cover bg-center bg-no-repeat md:block md:h-auto md:pr-[20px] md:pb-[50px] md:pl-[40px] lg:pr-[30px] lg:pb-[100px] lg:pl-[60px]"
      style={{ backgroundImage: `url(${bg})` }}
    >
      <h4 className="mb-4 font-semibold md:pt-[20%] md:text-[50px] lg:text-[60px]">
        {title}
      </h4>
      ...
      <Button
        variant="link"
        className="text-accent mt-5 hidden cursor-pointer pl-0 font-semibold md:block md:text-[20px] lg:text-[24px] xl:text-[32px]"
      >
        Подробнее
      </Button>
    </article>
